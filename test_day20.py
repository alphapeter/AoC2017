...
class TestDay20a(unittest.TestCase):
    ...
    def test_test_input(self):
        self.assertEqual(0, day20.calc_a(test_input))

    def test_input(self):
        self.assertEqual(125, day20.calc_a(input))


class TestDay20b(unittest.TestCase):

    def test_test_case(self):
       self.assertEqual(1, day20.calc_b(test_input_b))

    def test_case(self):
       self.assertEqual(461, day20.calc_b(input))


test_input = """p=< 3,0,0>, v=< 2,0,0>, a=<-1,0,0>
p=< 4,0,0>, v=< 0,0,0>, a=<-2,0,0>"""

test_input_b = """p=<-6,0,0>, v=< 3,0,0>, a=< 0,0,0>    
p=<-4,0,0>, v=< 2,0,0>, a=< 0,0,0>
p=<-2,0,0>, v=< 1,0,0>, a=< 0,0,0>
p=< 3,0,0>, v=<-1,0,0>, a=< 0,0,0>"""

input = """p=<-317,1413,1507>, v=<19,-102,-108>, a=<1,-3,-3>

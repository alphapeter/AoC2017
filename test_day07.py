...
class TestDay07a(unittest.TestCase):
    ...
    def test_case1(self):
        self.assertEqual("tknk", day07.calc_a(test_input_a))

    def test_input(self):
        self.assertEqual("hlhomy", day07.calc_a(input))


class TestDay07b(unittest.TestCase):

    def test_case1(self):
       self.assertEqual(60, day07.calc_b(test_input_a))

    def test_case(self):
       self.assertEqual(1505, day07.calc_b(input))

test_input_a = """pbga (66)
xhth (57)
ebii (61)
havc (66)
ktlj (57)

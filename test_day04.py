...
class TestDay04a(unittest.TestCase):
    ...
    def test_case1(self):
        self.assertEqual(1, day04.calc_a("aa bb cc dd ee"))
    def test_case2(self):
        self.assertEqual(0, day04.calc_a("aa bb cc dd aa"))
    def test_case3(self):
        self.assertEqual(1, day04.calc_a("aa bb cc dd aaa"))

    def test_input(self):
        self.assertEqual(451, day04.calc_a(input))


class TestDay04b(unittest.TestCase):
    def test_case1(self):
        self.assertEqual(1, day04.calc_b("abcde fghij"))

    def test_case2(self):
        self.assertEqual(0, day04.calc_b("abcde xyz ecdab"))

    def test_case3(self):
        self.assertEqual(1, day04.calc_b("a ab abc abd abf abj"))

    def test_case3(self):
        self.assertEqual(1, day04.calc_b("iiii oiii ooii oooi oooo"))

    def test_case4(self):
        self.assertEqual(0, day04.calc_b("oiii ioii iioi iiio"))


    def test_case(self):
        self.assertEqual(223, day04.calc_b(input))

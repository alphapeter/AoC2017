...
class TestDay08a(unittest.TestCase):
    ...
    def test_case1(self):
        self.assertEqual(1, day08.calc_a(test_input))

    def test_input(self):
        self.assertEqual(4647, day08.calc_a(input))


class TestDay08b(unittest.TestCase):

    def test_case1(self):
       self.assertEqual(10, day08.calc_b(test_input))

    def test_case(self):
       self.assertEqual(5590, day08.calc_b(input))
